...
function ModalForm({ children, title, trigger, back_url }) {
        ...
        <div className={`modal ${(modalStatus || trigger) && 'active'}`}>
            <div className='modal-container'>
                <div className="form-header">
                    {trigger && (
                        <Link href={back_url}>
                            <svg className='back_aside_arrow' width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
